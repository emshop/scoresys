	...
	<div class="panel panel-default">
		...
		<div class="panel-body" id="panel-body">
			<el-form ref="form" :inline="true" class="form-inline pull-left">
				<el-form-item>
					<el-input clearable size="medium" v-model="queryData.name" placeholder="请输入姓名">
					</el-input>
				</el-form-item>
...
<script>
import Add from "./user.info.add"
import Edit from "./user.info.edit"
export default {
  components: {
		Add,
		Edit
  ...
  mounted(){
    ...
    resetForm(formName) {
      ...
      this.$emit("addTab","详情"+val.uid,"/user/info/detail",data);
		},
    showAdd(){
      this.$refs.Add.show();
		},
