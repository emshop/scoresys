            ...
            <tbody class="table-border">
              <tr>
                <td>                 
                  ...
                  <el-col :span="6">
                    <div >{{ info.c_tp | fltrEnum("c_tp") }}</div>
                  </el-col>                 
                  <el-col :span="6">
              ...
              <tr>
                <td>                 
                  <el-col :span="6">
                    <div class="pull-right" style="margin-right: 10px">剩余:</div>
                  </el-col>
                  <el-col :span="6">
                    <div>{{ info.remain |  fltrNumberFormat(0)}}</div>
                  </el-col>                 
                  <el-col :span="6">
...
<script>
    ...
    methods: {
      ...
      queryData() {
        this.info = this.$http.xget("/score/record",this.$route.query)
      },
      handleClick(tab) {}
    },
	}
