<template>
	<el-dialog title="编辑惩罚信息" width="65%" @closed="closed" :visible.sync="dialogFormVisible">
      ...
      <el-form-item label="名称" prop="pn_name">
				...
				clearable v-model="editData.pn_name" placeholder="请输入名称">
				</el-input>
      </el-form-item>
...
export default {
	...
	methods: {
		...
		show() {
			this.editData = this.$http.xget("/punishment/info", { pn_id: this.editData.pn_id })
			this.dialogFormVisible = true;
		},
		edit() {
			this.$http.put("/punishment/info", this.editData, {}, true, true)
			.then(res => {			
